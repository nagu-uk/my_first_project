...
class DeptsControllerTest < ActionController::TestCase
  ...
  test "should create dept" do
    assert_difference('Dept.count') do
      post :create, dept: { code: @dept.code, in_charge: @dept.in_charge, loc: @dept.loc, name: @dept.name }
    end
  ...
  test "should update dept" do
    patch :update, id: @dept, dept: { code: @dept.code, in_charge: @dept.in_charge, loc: @dept.loc, name: @dept.name }
    assert_redirected_to dept_path(assigns(:dept))
  end
